<div class="blog-post">
    ...
    <ul>
        ...
        <li>Nulla vitae elit libenulla sed consectetur. Etiam porta sem malesuada magna mollis euismod.
            ...
            <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean
                lacinia bibendum nulla ro, a pharetra augue.
        </li>
    </ul>
...
<article class="va-c-article">
    <header>
        ...
        <div class="va-c-article__meta"><?php echo ($post['created_at']) ?> by <?php echo ($post['first_name']) ?> <?php echo ($post['last_name']) ?></div>
    </header>
